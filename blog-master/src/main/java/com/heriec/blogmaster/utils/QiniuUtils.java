...
public class QiniuUtils {
    ...
    private static final String ACCESS_KEY = "_5yK1ENKgR8jKgrk-9uLT22Iqa-u2-y2NnVS36L5";
    private static final String SECRET_KEY = "PzfGsOIzQai7SzelksYS4CVxJdWuaMB5gCWADLAF";
    ...
    private static final String DOMAIN = "r2nvlp5zo.hn-bkt.clouddn.com";
