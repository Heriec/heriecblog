    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item> <i class="el-icon-lx-addressbook"></i> 分类目录 </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                <el-button type="primary" icon="el-icon-plus" class="handle-plus mr10" @click="handleAdd">添加分类</el-button>
                <el-input v-model="query.category_name" placeholder="分类名称" class="handle-input mr10"></el-input>
            ...
            <el-table :data="categoryList" border class="table" header-cell-class-name="table-header">
...
export default {
    ...
    methods: {    
        ...
        handleSearch(currentPage) {
            ...
            _this.categoryList = [];
            this.$axios
                .get('/admin/category/getCateGoryByName/'+_this.query.category_name, {
                    params: {
                        currentPage: currentPage
                    }
                })
        ...
        getData(currentPage){
            if(this.tmp==1)
                this.getAllCategory(currentPage);
            else
